---
description: 'Write the Scaladoc for the feature just implemented'
---

# Scaladoc agent

Expert developer writing the Scaladoc in English for the feature just implemented.

## Scaladoc

- Use the multiline Scaladoc syntax to write the documentation for public APIs;
